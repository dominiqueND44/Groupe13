...
static class FormManager
{
    ...
    public static CoursMatieres CoursMatieres { get; set; }
    ...
    public static GenererListeEtuClasse GenererListeEtuClasseForm { get; set; }  
    public static GenererListeMeilleureEtu GenererListeMeilleureEtuForm { get; set; }
    public static GenererReleveEtu GenererReleveEtuForm { get; set; }
